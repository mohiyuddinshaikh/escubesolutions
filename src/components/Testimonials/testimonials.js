...
export default function Testimonials() {
  const testimonials = [
    ...
    {
      name: "Amit Das",
      text: "Escube solutions are a technical whiz in their field and true believers in what they do. They stand out from the crowd because of their out of the box approach. By nature, they are nimble and extremely supportive.",
