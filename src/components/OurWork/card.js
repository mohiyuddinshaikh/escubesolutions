        ...
        <div className="px-6 py-4 bg-gray-800">
          ...
          <div className="flex flex-wrap text-base mb-2 gap-1">
            {project?.support?.includes(1) ? (
              <div className="flex justify-center items-center font-medium py-1 px-2 bg-white rounded-full text-blue-700 bg-blue-100 border border-blue-300 ">
            ...
            {project?.support?.includes(2) ? (
              <div className="flex justify-center items-center font-medium py-1 px-2 bg-white rounded-full text-green-700 bg-green-100 border border-green-300 ">
                <div className="text-xs font-normal leading-none max-w-full flex-initial">
                  Mobile
                </div>
              </div>
